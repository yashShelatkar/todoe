...
class ListController: UIViewController, TONewItemDelegate, TOHeaderDelegate {
...
extension ListController: UITableViewDelegate, UITableViewDataSource, TOListCellDelegate {
    ...
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let titleForHeader = TOLabel(color: .white, size: 20, frame: CGRect(x: 0, y: 0, width: tableView.frame.width, height: 44))
        if section == 0 {
